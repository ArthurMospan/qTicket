...
| Client company visibility and administration | **Adapt** organization-level customer visibility | One qTicket client project is the customer's support space. `client_admin` invites only client roles into a project they hold themselves; no arbitrary cross-project sharing or request participants. |
