  ...
  return (
    <div className="flex flex-col gap-[32px]">
      ...
      <PreviewBlock
        ...
        description="Прогрес виконання показує частку одного цілого без декоративної оцінки кольором. Значення і підпис лишаються текстом, тому смуга не є єдиним носієм змісту."
        filePath="src/components/ui/Charts/Meter.jsx"
        component="Meter"
        fullWidth
      >
        <div className="grid w-full grid-cols-1 gap-5 sm:grid-cols-3">
          <Meter value={0.42} label="Виконано" reading="42%" />
          <Meter value={0.78} label="Виконано" reading="78%" />
          <Meter value={0.96} label="Виконано" reading="96%" />
        </div>
