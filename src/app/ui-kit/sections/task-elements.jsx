      ...
      >
        <div className="flex w-full flex-col gap-2">
          ...
          <ActivityRow
            ...
            onClick={() => {}}
          />
          {/* Те, що бачить клієнт: діяла підтримка, але не сказано хто саме.
              Знак замість обличчя — бо це стіл, а не людина, і водночас не
              «ніхто»: без нього рядок виходив сірим за семипіксельною крапкою,
              і найважливіша подія на екрані була найблідішою. */}
          <ActivityRow
            fromSupport
            actorName="Підтримка"
            text="змінила статус звернення"
            issueKey="ACME-38"
            title="Повільно вантажиться дашборд"
            time="11 черв, 18:44"
            onClick={() => {}}
          />
          {/* І справді безсуб'єктна подія — крапка, той самий лівий край. */}
          <ActivityRow
            text="Звернення оновлено"
            issueKey="ACME-30"
