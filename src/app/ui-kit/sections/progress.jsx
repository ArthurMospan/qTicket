'use client';
import { KpiCard, Surface } from '@/components/ui';
...
export default function ProgressSection() {
  return (
    <div className="flex flex-col gap-[32px]">
      <PreviewBlock title="KPI Cards" description="Живі KpiCard з черги звернень — ті самі чотири, що на «Огляді». Картка не має власної рамки: вона завжди стоїть на сірій панелі, як тут і як на «Огляді» та «Аналітиці»." fullWidth>
