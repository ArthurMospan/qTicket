...
export default function ChatElementsSection() {
  ...
  return (
    <div className="flex flex-col gap-[32px]">
      ...
      <PreviewBlock
        title="IssueMentionMenu — згадки звернень через #"
        description="Після # і двох символів композер шукає доступні звернення за ID, назвою та описом. Вибір вставляє стабільний ключ, а не довге посилання; у повідомленні цей ключ стає клікабельною карткою звернення. Заголовок аркуша задає call site через heading, але слово одне: і підтримка, і зовнішній клієнт згадують «звернення»."
