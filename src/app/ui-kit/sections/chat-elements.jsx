...
export default function ChatElementsSection() {
  ...
  return (
    <div className="flex flex-col gap-[32px]">
      ...
      <PreviewBlock
        title="IssueMentionMenu — згадки інцидентів через #"
        description="Після # і двох символів композер шукає доступні інциденти за ID, назвою та описом. Вибір вставляє стабільний ключ, а не довге посилання; у повідомленні цей ключ стає клікабельною карткою інциденту. Заголовок аркуша задає call site через heading: той самий композер стоїть перед двома аудиторіями, і зовнішній клієнт згадує «звернення», а не «інцидент»."
