...
export async function PATCH(request, context) {
  try {
    ...
    const result = await db.runTransaction(async transaction => {
      ...
      // Both halves of the same fact, written once. `audit/` is the support-side
      // work record; `recordIssueHistory` copies the line into the customer's
      // feed as well, because a request moving from Новий to Вирішено is the
      // thing the person who filed it came to the screen to read.
