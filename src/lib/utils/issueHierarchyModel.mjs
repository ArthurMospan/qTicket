const ERROR_DEFINITIONS = Object.freeze({
  INVALID_PARENT_ID: {
    status: 400,
    message: 'Некоректний ідентифікатор основного звернення',
  },
  SELF_PARENT: {
    status: 400,
    message: 'Звернення не може бути дочірнім для себе самого',
  },
  PARENT_NOT_FOUND: {
    status: 404,
    message: 'Основне звернення не знайдено',
  },
  ...
  PARENT_IS_CHILD: {
    status: 409,
    message: 'Дочірнє звернення не може мати власні дочірні',
  },
  ISSUE_HAS_CHILDREN: {
    status: 409,
  ...
  ISSUE_DELETING: {
    status: 409,
    message: 'Звернення вже видаляється',
  },
  PARENT_DELETING: {
    status: 409,
    message: 'Основне звернення вже видаляється',
  },
});
