...
// зовнішнього клієнта. Тому жоден рядок тут не називає запис: для підтримки
// це «інцидент», для клієнта «звернення», а один статичний список не може
// сказати обидва. Рядки називають те, з чим людина взаємодіє.
//
...
export const SHORTCUT_GROUPS = Object.freeze([
  ...
  Object.freeze({
    label: 'У списках, на дошці й у таблиці',
    items: Object.freeze([
      Object.freeze({ keys: ['Shift', 'Клік'], label: 'Почати вибір із цього рядка' }),
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      ...
      Object.freeze({ keys: ['#'], label: 'Послатись за номером' }),
