...
const HELP_ARTICLE_CATALOGUE = Object.freeze([
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'what', title: 'Про що вам повідомлять', paragraphs: ['Нове звернення від клієнта, призначення звернення, нова відповідь, згадка, зміна статусу та наближення терміну вирішення. Про власні дії сповіщення не створюються.'], bullets: ['Про нове звернення дізнається команда підтримки того клієнтського простору, у якому його створили — тобто ті, хто веде саме цього клієнта, а не вся організація. Якщо підтримку до простору ще не призначено, сповіщення отримують власник і адміністратори, щоб звернення не залишилось непоміченим.', 'Це сповіщення не вимикається: подія, заради якої існує служба підтримки, не має власного перемикача.'] },
