...
const HELP_ARTICLE_CATALOGUE = Object.freeze([
  ...
  },
  {
    ...
    sections: [
      { id: 'profile', title: 'Профілі команди підтримки', paragraphs: ['Натисніть на учасника у «Команді», щоб побачити його контакти, роль і доступні звернення. Клієнтські працівники керуються окремо у вкладці «Люди» свого клієнтського простору й не змішуються з внутрішньою командою.'] },
