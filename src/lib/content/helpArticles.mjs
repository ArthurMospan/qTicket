...
const HELP_ARTICLE_CATALOGUE = Object.freeze([
  ...
  },
  {
    ...
    sections: [
      ...
      { id: 'read', title: 'Що гасне саме', paragraphs: ['Запис про звернення, яке ви зараз читаєте, позначається прочитаним одразу, без звуку й картки: він існував, щоб привести вас туди, де ви вже є. Усе інше лишається непрочитаним, доки ви не відкриєте те звернення або не позначите запис у дзвіночку. Крапка біля проєкту в бічній панелі означає непрочитані записи в його зверненнях і гасне разом з ними, а не від самого відкриття проєкту.'] },
